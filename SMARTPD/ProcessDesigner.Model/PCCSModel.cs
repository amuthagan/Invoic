...
{
    public class PCCSModel : ViewModelBase
    {
        ...
        private string enqu_recd_on;
        public string ENQU_RECD_ON
        {
    ...
    public class CustomerDetailsModel
    {
        ...
        public string cust_ref_for_sfl { get; set; }
        public string cust_dwg_no_issue { get; set; }
        public DateTime? cust_std_date { get; set; }
    }
}
