...
{
    public class TfcPCRViewModel : ViewModelBase
    {
        private TfcPCRBll tfcbll;
        ...
        public TfcPCRViewModel(UserInformation userInfo)
        {
            tfcbll = new TfcPCRBll(userInfo);
        ...
        public void GridLoad()
        {
            ...
            dt.Rows.Add("Can the material source change permitted ?", "");
            dt.Rows.Add("Whether inspection methodology change be adoptable ?", "");
        ...
        private void SelectDataRowPart()
        {
            ...
            if (SelectedRowPart != null)
            {
                ...
                tfcbll.GetIssueNoDatePCR(TFCMODEL);
        ...
        private void Clear()
        {
            ...
            TFCMODEL.PCR_NO = "";
            TFCMODEL.PCR_DATE = DateTime.Now;
            TFCMODEL.FEASIBLEPRODUCT = false;
            TFCMODEL.NOTFEASIBLE = false;
            TFCMODEL.ROUTENO = "";
            IsRecordsUpdated = false;
